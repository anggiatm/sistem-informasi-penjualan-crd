                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Ambil Order?</h5>
                ...
                function writeCard(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            if (data[i].status == "selesai-dirakit" && data[i].driver == "") {
                            ...
                            function drawCard(color) {
                                ...
                                html += '</span>'
                                html += '<span class="text">Ambil Order</span>'
                                html += '</button>'
