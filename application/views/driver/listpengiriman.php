...
<body id="page-top">
    <input type="hidden" class="form-control form-control-sm" id="driver" value=" <?php echo $_SESSION['username'] ?>" disabled>
    <div id="wrapper">
            ...
            <div class="modal fade" id="modal-konfirmasi-selesai" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Pekerjaan Telah Selesai?
                            <input type="text" class="form-control form-control-sm" id="modal-title" disabled>
                        </div>

                        <div class=" modal-footer">
                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                            <button class="btn btn-primary" id="btn-selesai">Selesai</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <script>
                ...
                function writeCard(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            if (data[i].status == "dalam-pengiriman" && data[i].driver == $('#driver').val()) {
                            ...
                            function drawCard(color) {
                                ...
                                html += '</span>'
                                html += '<span class="text">Pekerjaan Selesai</span>'
                                html += '</button>'
                ...
                function writeModal(key) {
                    ...
                    $('#btn-selesai').click(function() {
                        var kontruksi = $('#driver').val();
                        var status = "selesai-dikirim";
